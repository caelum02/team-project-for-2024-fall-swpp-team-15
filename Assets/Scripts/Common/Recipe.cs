...
namespace Yogaewonsil.Common {
    public static class Recipe {
        ...
        private static readonly (CookMethod mthd, Food[] inFoods, Food outFood)[] recipeList = 
        {
            // 초밥류
            new(밥짓기, new[] { 쌀 }, 밥),
            new(합치기, new[] { 식초, 밥 }, 식초밥),
            // 계란초밥
            new(굽기, new[] { 계란 }, 계란말이),
            new(초밥제작, new[] { 계란말이, 식초밥 }, 계란초밥),
            // 유부초밥
            new(손질, new[] { 두부 }, 두부조각),
            new(튀기기, new[] { 두부조각 }, 유부),
            new(초밥제작, new[] { 유부, 식초밥 }, 유부초밥),
            // 광어초밥
            new(손질, new[] { 광어 }, 손질된광어),
            new(초밥제작, new[] { 손질된광어, 식초밥 }, 광어초밥),
            // 고등어초밥
            new(손질, new[] { 고등어 }, 손질된고등어),
            new(초밥제작, new[] { 손질된고등어, 식초밥 }, 고등어초밥),
            // 소고기초밥
            new(손질, new[] { 소고기 }, 손질된소고기),
            new(손질, new[] { 손질된소고기 }, 소고기조각),
            new(굽기, new[] { 소고기조각 }, 구운소고기조각),
            new(초밥제작, new[] { 구운소고기조각, 식초밥 }, 소고기초밥),
            // 참치붉은속살초밥 (일반참치)
            new(손질, new[] { 일반참치 }, 손질된일반참치),
            new(초밥제작, new[] { 손질된일반참치, 식초밥 }, 참치붉은속살초밥),
            // 연어초밥 (연어->연어필렛->연어조각->연어초밥)
            new(손질, new[] { 연어 }, 연어필렛),
            new(손질, new[] { 연어필렛 }, 연어조각),
            new(초밥제작, new[] { 연어조각, 식초밥 }, 연어초밥),
            // 훈제연어초밥 (연어->연어필렛->연어조각->구운연어조각->훈제연어초밥)
            new(손질, new[] { 연어 }, 연어필렛),
            new(손질, new[] { 연어필렛 }, 연어조각),
            new(굽기, new[] { 연어조각 }, 구운연어조각),
            new(초밥제작, new[] { 구운연어조각, 식초밥 }, 훈제연어초밥),
            // 장어초밥 (장어->손질된장어->구운장어조각->장어초밥)
            new(손질, new[] { 장어 }, 손질된장어),
            new(굽기, new[] { 손질된장어 }, 구운장어조각),
            new(초밥제작, new[] { 구운장어조각, 식초밥 }, 장어초밥),
            // 참치대뱃살초밥 (고급참치)
            new(손질, new[] { 고급참치 }, 손질된고급참치),
            new(초밥제작, new[] { 손질된고급참치, 식초밥 }, 참치대뱃살초밥),
            ...
            new(손질, new[] { 손질된소고기 }, 소고기조각),
            new(굽기, new[] { 소고기조각 }, 구운소고기조각),
            new(비가열조리, new[] { 구운소고기조각, 손질된채소, 계란, 밥 }, 규동),
            // 사케동 (연어조각, 간장, 손질된채소, 밥)
